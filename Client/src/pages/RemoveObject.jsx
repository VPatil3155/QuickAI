    ...
    const {getToken}=useAuth();
      ...
      const onSubmitHandler=async(e)=>{
       ...
       formData.append('object',object)
        ...
        const { data }=await axios.post('/api/ai/remove-images-object',formData,{headers:{Authorization:`Bearer ${await getToken()}`}})
   ...
   <div className='h-full overflow-y-scroll p-6 flex items-start
     flex-wrap gap-4 text-slate-700 '>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        text-sm rounded-md border border-gray-300' placeholder='watch or spoon , Only single object name' required/>
